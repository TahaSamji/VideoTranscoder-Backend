        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EncodingProfileId = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_VideoMetaDatas", x => x.Id);
                    table.ForeignKey(
                        name: "FK_VideoMetaDatas_EncodingProfiles_EncodingProfileId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Thumbnails_VideoMetaDatas_FileId",
                        column: x => x.FileId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TranscodingJobs_VideoFileId",
                table: "TranscodingJobs",
                column: "VideoFileId");

            migrationBuilder.CreateIndex(
                name: "IX_VideoMetaDatas_EncodingProfileId",
